...
5-2 운영 대시보드(9탭,free) · 5-22 캠페인 포화도 탐지(한계 CPA/ROAS, §12.16) · 5-3 예산 배분 · 5-4 실험 분석(A/B 2탭) · 5-23 증분 분석(홀드아웃 3방법: 통제군·on·off, §12.22) · 5-6 소재 · 5-18 마케팅 반응 분석(3탭: 카니발·MMM 기여·회귀+미래예측[Cost·임의변수·OS별·MMM브리지], §12.15) · 5-20 핵심 가치 발굴(Aha-moment) · 5-21 PVM 변동 탐지. **컨텐츠 분석(9-x, §12.23)**: 퍼포먼스 엔진 도메인 리라벨 — 9-1 콘텐츠 요소 분석기(regMath), 9-2 킬러 콘텐츠(ahaMath), 9-3 트래픽 변동(pvmMath·유입경로→카테고리→콘텐츠·방문당 비용), 9-6 신선도(creativeMath·소재→콘텐츠·피로도→신선도), 9-7 콘텐츠 운영 대시보드(dashboard 엔진·3탭 viz/scorecard/anomaly만·prop drilling·부적합 지표 정직 제외). **9-4 CMM 드롭**(MMM 금액 스케일 vs 콘텐츠 편수 불일치). 상세는 CLAUDE.md §4.2·§12.23. **신규 도구는 디자인시스템 공용규약 필수(§12.21: format.js·전역통화·ds/DataTable·CsvGuide).**
