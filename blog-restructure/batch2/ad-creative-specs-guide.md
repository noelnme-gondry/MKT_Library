...
keywords: "광고 소재 규격, 매체별 소재 사이즈, 영상 세이프존, 플레이어블 광고 규격, 소재 검수 거절, 앱 광고 소재 가이드, 광고 소재 사이즈, 소재 제작 가이드, 영상 광고 규격, 광고 검수"
tags: ["소재", "기초"]
draft: false
---
...
세이프존 사고는 제작 마지막 단계에서 제일 많이 나요. 디자이너 화면에선 완벽했는데, 실제 지면에 올라간 걸 폰으로 열어보니 CTA 버튼이 가격 자막을 정확히 가리고 있는 그림이요. 그래서 검수 통과가 아니라 **실기기 확인**을 마지막 관문으로 두는 게 좋아요. 미리보기 도구도 있지만, 내 폰 피드에서 직접 보는 것만큼 확실한 게 없어요.
