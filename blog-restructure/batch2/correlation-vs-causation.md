...
이 함정이 제일 자주 걸리는 자리가 성과 보고예요. "이번 달 신규 캠페인 덕분에 매출이 20% 올랐습니다"라는 문장, 한 번쯤 써보셨을 거예요(수치는 가정이에요). 그런데 같은 달에 시즌도 왔고, 앱 업데이트도 나갔고, 경쟁사가 광고를 줄였을 수도 있죠. 겹친 것 중 캠페인의 몫이 얼마인지는 그 문장만으론 아무도 몰라요. '덕분에'를 '기간에'로만 바꿔 써도 보고의 정직함이 달라져요.
