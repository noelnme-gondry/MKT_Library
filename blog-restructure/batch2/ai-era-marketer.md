...
이 이동은 채용 공고에서도 보여요. 몇 년 전엔 "매체 운영 경험 O년"이 요건의 전부였는데, 요즘 공고엔 "실험 설계", "증분 검증", "예산 의사결정" 같은 단어가 올라와요. 조작을 잘하는 사람이 아니라 **기계에게 뭘 시킬지 아는 사람**을 찾는다는 뜻이죠. 시장이 이미 무게중심 이동에 가격을 매기고 있는 거예요.
