---
title: "You Raised the Budget on a Winning Campaign — Why Did It Break?"
...
keywords: "budget scaling, saturation, response curve, frequency increase, rising CPA, marginal utility"
...
![A graph of conversions versus ad spend. The dashed line is the linear expectation — "spend 2x, get 2x." The solid blue line is the actual response curve, which flattens as spend increases. The green dot marks the current spend level, still in the room-to-grow zone. From the red dot onward is the saturation zone, and the gap between the two lines is labeled as the shortfall.](/blog-assets-en/scaling-pitfalls/response-curve.svg)
