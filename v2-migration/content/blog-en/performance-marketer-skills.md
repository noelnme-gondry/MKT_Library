...
![Tools split into four functional slots: execution (media ads managers), collection (GA4, MMPs), processing (spreadsheets, SQL, BI tools), and judgment (incrementality, saturation, allocation, attribution). The slot juniors skip most often is judgment, on the far right.](/blog-assets-en/performance-marketer-skills/tool-stack.svg)
