...
description: "Four hook patterns to test that stop the scroll in a video ad's first three seconds, plus a checklist for the opening frame."
date: "2026-07-18"
...
## Four hook patterns to test

- **① Direct address**: the presenter looks straight into camera and recommends as if talking to you. Works well in trust-heavy categories (commerce, fintech, health).
- **② Problem statement**: throw the target's pain point up front as a caption or quick vignette. The "ever had this happen?" style.
...
All four share one principle: convince the viewer "this is relevant to me" in the opening moment. Don't decide which pattern fits your product by gut — run two or three and [compare with an A/B test](/blog/ab-testing).

## Opening-frame (freeze frame) checklist

Pause the video at 0 seconds. All of this should be visible.

1. A face or strong visual (a plain UI screenshot is weak)
2. One short, large caption line
3. That caption sitting inside the [safe zone](/blog/ad-creative-specs-guide), clear of platform UI
4. Strong color contrast
5. Message that lands **with sound off** — muted autoplay is the default
6. One piece of motion moving against the scroll direction
7. Not obviously "an ad" (it reads like content)

## How to measure it

The hook's success isn't a feeling — split it into three metrics.
...
Once the hook hypothesis is set, [ad creative testing](/blog/ad-creative-testing) covers how many to run on what budget, and [ad creative performance analysis](/blog/content-element-analysis) covers what actually drove the result afterwards.
