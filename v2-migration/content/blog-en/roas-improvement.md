---
title: "ROAS Dropped? Cutting Budget Is Usually the Wrong Move"
...
keywords: "ROAS improvement, marginal ROAS, ROAS decline, ROAS by channel, budget reallocation, saturation, performance marketing"
...
![A bar chart showing an overall average ROAS of 300%, but a wide spread once broken down by channel: Channel A at 480%, Channel B at 320%, Channel D at 250%, and Channel C dragging the average down at 150%.](/blog-assets-en/roas-improvement/roas-by-channel.svg)
...
![A diagram showing Channel A with an average ROAS of 480% but, because it's already saturated, a marginal ROAS of only 160%, while Channel B has a lower average of 320% but a marginal ROAS near 300% because it still has room — making it worth shifting budget from A to B.](/blog-assets-en/roas-improvement/marginal-roas-reallocation.svg)
...
So the answer is clear. Shift budget from A to B and overall ROAS goes up. If you go by average alone and think "A is best, pile it all there," you end up moving in exactly the wrong direction. We go deeper on this marginal-utility view in our [marketing budget allocation post](/en/blog/marketing-budget-allocation).
...
Maybe the season happened to be good that week, or a competitor pulled back, or a promotion overlapped. ROAS rising *at the same time as* reallocation is different from reallocation *causing* the rise. Conflate the two and your next decision goes sideways. If this distinction feels fuzzy, see our [correlation vs. causation post](/en/blog/correlation-vs-causation).

If you want to actually confirm reallocation worked, the standard approach is a [holdout experiment](/en/blog/incrementality-measurement) — move budget in one place and leave a comparable one untouched. Observation alone only gets you association; confirmation needs an experiment.
