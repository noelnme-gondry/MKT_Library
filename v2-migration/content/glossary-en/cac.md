...
faq:
  ...
  - q: "Are CAC and CPA the same thing?"
    a: "They overlap but the conventions differ. CPA usually measures the media cost of one specific action at campaign level, while CAC measures everything spent to win one customer at business level. With ad spend alone in the numerator, purchase-based CPA and media CAC can be the same number."
---
...
How CAC pairs with [LTV](/glossary/ltv) to guide channel decisions is covered in [LTV:CAC Ratio](/blog/ltv-cac-ratio).
