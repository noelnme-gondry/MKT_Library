...
- **세션 정의·집계 지연·임계값·unassigned**처럼 GA4 화면 안에서 숫자가 달라 보이면 이 글을 보세요.
- **메타·GA4·MMP·결제 DB가 서로 다른 전환 수를 보인다**면 [매체·MMP·GA4 숫자 맞추기](/blog/attribution-data-mismatch)로 가세요. 어떤 소스를 어떤 보고 질문에 쓸지 정하는 문제예요.
