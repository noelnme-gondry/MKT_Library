...
하루의 노이즈를 장기 문제처럼 고치면 학습을 불필요하게 리셋할 수 있습니다. 반대로 반복되는 하락을 기다리기만 하면 원인이 커질 수 있으니, 시간 범위부터 구분하세요.
...
소재 피로의 전형적인 신호는 **빈도는 오르고 CTR은 내려가는 조합**입니다. 같은 사람에게 반복 노출되면서 반응이 식는 상황이죠.
