...
description: "리타겟팅·재참여 캠페인을 신규 획득(UA)과 분리해야 하는 이유, 오디언스 세분화, 딥링크와 설치 후 연결을 구분하는 방법 정리했습니다."
date: "2026-07-18"
updated: "2026-09-09"
...
리타겟팅 광고를 눌렀는데 앱이 그냥 홈 화면만 뜨면, 유저는 자기가 보던 그 상품을 다시 찾아야 해요. 이탈이 크게 늘어요. 이미 설치된 앱에는 [딥링크](/glossary/deep-link)로 광고에서 약속한 화면까지 연결하세요. 설치를 거친 뒤 화면을 연결해야 할 때 디퍼드 딥링크를 검토합니다.
