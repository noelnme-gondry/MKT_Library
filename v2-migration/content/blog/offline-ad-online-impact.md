...
- **브랜드 검색량** — 광고 보고 이름을 검색해요. 반응 속도는 제품과 집계 방식에 따라 다릅니다.
...
클릭이 없는 매체를 시계열로 평가하는 같은 방법은 [브랜드 캠페인 효과 측정](/blog/brand-campaign-lift)에도 쓰이고, 그 결과를 증분으로 읽는 기준은 [증분성(인크리멘탈리티) 측정](/blog/incrementality-measurement)에 있습니다.
