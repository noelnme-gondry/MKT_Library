...
VIF를 보기 전에 MMM이 애초에 무엇을 추정하는 모형인지는 [마케팅 믹스 모델링(MMM)이란?](/blog/marketing-mix-modeling)에 있고, 관측 데이터라 연관이지 인과가 아니라는 한계는 [증분성(인크리멘탈리티) 측정](/blog/incrementality-measurement)과 함께 읽으면 분명해집니다.
