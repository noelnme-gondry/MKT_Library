...
안드로이드는 멀쩡한데 iOS만 성과가 반토막이라면, 캠페인이 아니라 **측정**을 먼저 의심해야 해요. iOS는 "추적을 허용하시겠어요?" 팝업(ATT) 이후 유저별 정밀 추적이 어려워졌고, 애플의 SKAdNetwork(SKAN)라는 제한된 집계 프레임으로 성과를 봐야 하거든요. 이 구조를 모르면 멀쩡한 iOS 캠페인을 숫자만 보고 끄게 돼요. 뭐가 어떻게 바뀌었고, 그 안에서 뭘 기준으로 판단하면 되는지 정리할게요.
