...
description: "CPI·CPA·CPM·CPC의 분자·분모·용도를 비교하고, 같은 예제에서 비용 지표를 계산해 성과 변화의 점검 순서를 찾습니다."
date: "2026-07-15"
updated: "2026-09-14"
...
faq:
  ...
  - q: "CPC가 올랐는데 CPM은 그대로면 무슨 뜻인가요?"
    a: "경매 단가는 그대로인데 클릭률이 떨어졌다는 뜻입니다. CPC는 CPM ÷ (1,000 × CTR)이라 분모인 CTR이 내려가면 CPC가 오릅니다. 이때는 입찰이 아니라 소재와 피로도를 먼저 보세요."
...
CPI·CPA·ROAS까지 포함한 전체 지표 사슬과 최적화 기준은 [퍼포먼스 마케팅 지표 가이드](/blog/performance-marketing-metrics)에서 먼저 보세요. 이 글에서는 네 비용 지표의 계산 기준을 비교한 뒤 CPM·CPC부터 변화를 좁혀봅니다.
...
비용의 통화·기간과 각 분모의 귀속 범위가 같아야 합니다. 분모가 0이거나 집계가 누락됐다면 단가를 0원으로 표시하지 않습니다. 신규 고객 한 명을 얻는 비용인 [CAC](/glossary/cac)는 가입 CPA나 주문당 비용과 구분하세요.
...
CPC 상승은 **CPM 상승·CTR 하락 또는 두 변화의 조합**으로 나눠 볼 수 있어요. 이 분해는 확인할 가설을 좁히지만 운영 원인을 확정하지는 않습니다.
...
앞의 사슬을 그대로 쓰면 이유가 보여요. `CPI = CPM ÷ (1,000 × CTR × 클릭→설치 전환율)`이고 `CPA = CPI ÷ 설치→행동 전환율`이에요. 즉 CPI와 CPA 사이에는 **설치→행동 전환율 하나**만 놓여 있어서, 둘이 갈렸다면 그 구간이 움직였다는 뜻이에요.

여기서 흔한 함정은 싸게 깔린 설치를 나쁜 유입으로 곧장 단정하는 거예요. 설치→행동 전환이 늦게 잡히는 앱이면 최근 며칠은 관측 기간이 덜 차서 CPA가 실제보다 나쁘게 보여요. 기간을 맞춰 다시 보고, 그래도 갈린다면 [운영 대시보드](/dashboard)에서 캠페인별로 두 지표를 나란히 놓고 어느 캠페인이 평균을 끌고 있는지 확인하세요.
