...
description: "CTR·CVR·CPA·ROAS로 시작해 CPM·CPC·CPI·LTV:CAC까지 사슬로 연결해 문제 위치를 찾는 실무 가이드입니다."
date: "2026-07-27"
updated: "2026-07-27"
...
이게 중요한 이유는, CPA가 결과라면 CPM·CTR·CVR은 원인이기 때문이에요. CPA가 높을 때 CPM이 높으면 매체 경쟁·타겟 단가 문제, CTR이 낮으면 소재·타겟 문제, 전환율이 낮으면 랜딩·[퍼널](/blog/funnel-dropoff-analysis) 문제예요. 결과만 보고는 소재를 갈지 타겟을 바꿀지 못 정해요.
