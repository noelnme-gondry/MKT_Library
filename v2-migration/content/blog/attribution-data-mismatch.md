...
- **메타·GA4·MMP·결제 DB가 서로 다르다**면 이 글을 보세요. 소스별 귀속 규칙과 보고 기준을 맞추는 문제예요.
- **GA4 세션이 UA와 다르거나, 어제 전환 수가 계속 바뀌거나, unassigned가 늘었다**면 [GA4 숫자 함정](/blog/ga4-data-traps)부터 보세요. GA4 안의 정의·처리 지연·임계값 문제예요.
