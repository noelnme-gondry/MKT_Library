...
const KO_TITLES = {
  ...
  "adattributionkit-transition": "AdAttributionKit 전환 준비: SKAN 운영팀 체크리스트",
  ...
  "ios-skan-campaign-structure": "iOS SKAN 캠페인 구조: source ID 해상도 설계",
  ...
  "skan-conversion-value-ltv": "SKAN conversion value를 LTV로 연결하는 설계",
  "skan-crowd-anonymity-tiers": "SKAN crowd anonymity 티어: 왜 값이 줄어드는가",
  "skan-network-differences": "매체별 SKAN 처리 차이: 표준과 플랫폼 설정 구분",
  "skan-null-redacted-postbacks": "SKAN null·누락 postback: 데이터 없음과 익명화 구분",
  "skan-conversion-value-schema": "SKAN 컨버전 밸류 설계: 64칸에 뭘 담을까",
  "skan-schema-validation": "SKAN 스키마 변경 후 검증: 정상 여부 확인 순서",
...
const EN_TITLES = {
  ...
  "adattributionkit-transition": "Preparing for AdAttributionKit: A SKAN Checklist",
  ...
  "ios-skan-campaign-structure": "iOS SKAN Campaign Structure: Source Identifier Design",
  ...
  "skan-conversion-value-ltv": "Connecting SKAN Conversion Value to LTV",
  "skan-crowd-anonymity-tiers": "SKAN Crowd Anonymity Tiers Explained",
  "skan-network-differences": "SKAN by Network: Standard vs Platform Settings",
  "skan-null-redacted-postbacks": "SKAN Null Postbacks: Missing Data vs Privacy",
  "skan-conversion-value-schema": "SKAN Conversion Value: What Fits in 64 Slots",
  "skan-schema-validation": "SKAN Schema Validation After a Change",
