...
const KO_TITLES = {
  ...
  "ad-machine-learning": "광고 학습 단계: 머신러닝 학습 중 CPA가 흔들리는 이유",
  "ad-performance-diagnosis": "광고 성과 하락 원인: CPA 상승·CTR 하락 때 확인할 4단계",
  "aha-event-ad-optimization": "광고 최적화 이벤트: 설치 대신 Aha Event로 바꾸기",
  "aha-moment-retention": "Aha Moment 찾는 법: 초기 행동과 리텐션 분석",
  "ai-era-marketer": "AI 시대 퍼포먼스 마케터 역량: 자동화 이후에도 남는 일",
  "apple-search-ads-guide": "Apple Search Ads 키워드 최적화: 검색어·제외 키워드·입찰",
  "asa-keyword-expansion": "ASA 키워드 확장: Discovery에서 Exact로 승격하는 기준",
  "aso-basics-guide": "ASO란? 앱스토어 최적화 전략: 키워드·스크린샷·전환율",
  "store-conversion-drop-diagnosis": "앱스토어 전환율 하락 원인: 스토어 페이지 탓인가 유입 탓인가",
  "store-listing-experiment": "앱스토어 A/B 테스트: Apple PPO·Google Play 실험 설계와 판독",
  "attribution-data-mismatch": "어트리뷰션 데이터 불일치: GA4·MMP·매체 전환수가 다른 이유",
  ...
  "campaign-anomaly-detection": "캠페인 이상 탐지: 오늘 CPA 급등이 진짜 이상인지 판별하기",
  ...
  "cpi-cpa-cpm-difference": "CPI·CPA·CPM·CPC 차이: 뜻과 계산법, 어떤 지표를 볼까",
  "creative-attribute-regression": "광고 소재 회귀분석: A/B 테스트 없이 썸네일·제목 비교하기",
  ...
  "incrementality-measurement": "증분성(인크리멘탈리티) 측정: 광고 효과를 홀드아웃으로 검증",
  ...
  "performance-marketing-analysis-order": "퍼포먼스 마케팅 데이터 분석: 가진 데이터로 뭘 먼저 볼까",
  ...
  "uplift-holdout-guide": "광고 업리프트 측정: 홀드아웃 테스트로 순수 증가분 읽기",
...
const EN_TITLES = {
  ...
  "aha-event-ad-optimization": "Ad Optimization Events: Use the Aha Event, Not Installs",
  "ai-era-marketer": "The AI-Era Performance Marketer: Skills That Still Matter",
  "attribution-data-mismatch": "Attribution Data Mismatch: Why GA4, MMP, and Media Disagree",
  ...
  "performance-marketing-analysis-order": "Performance Marketing Analysis: Choose the Right Method",
  "aha-moment-retention": "How to Find the Aha Moment: Early Actions and Retention",
  "apple-search-ads-guide": "Apple Search Ads Keyword Optimization: Terms, Negatives, Bids",
  "asa-keyword-expansion": "ASA Keyword Expansion: When to Promote Discovery to Exact",
  ...
  "creative-attribute-regression": "Ad Creative Regression: Compare Thumbnails Without A/B Tests",
  "offline-ad-online-impact": "Measuring TV and Offline Ad Impact Online",
  "aso-basics-guide": "ASO Strategy: Keywords, Screenshots, and Store Conversion",
  "store-conversion-drop-diagnosis": "App Store Conversion Rate Dropped: Page Problem or Traffic Mix?",
  "store-listing-experiment": "App Store A/B Testing: Designing and Reading PPO Experiments",
  "campaign-anomaly-detection": "Campaign Anomaly Detection: Is Today's CPA Spike Real?",
  ...
  "cpi-cpa-cpm-difference": "CPM vs CPC vs CPI vs CPA: Meaning, Formulas, and Which to Use",
...
const KO_H1 = {
  ...
  "performance-marketing-analysis-order": "내 데이터로 어떤 분석부터 할 수 있을까?",
  "incrementality-measurement": "광고가 실제로 만든 전환은 얼마일까?",
  "attribution-data-mismatch": "GA4와 광고 매체의 전환수가 왜 다를까?",
  "store-conversion-drop-diagnosis": "앱스토어 전환율이 떨어졌을 때 어디를 봐야 할까?",
  "apple-search-ads-guide": "Apple Search Ads에서 낭비되는 키워드 찾기",
  "campaign-anomaly-detection": "CPA가 하루 만에 급등했을 때 이상인지 판별하는 법",
  "cpi-cpa-cpm-difference": "CPI·CPA·CPM·CPC는 각각 무슨 뜻일까?",
  "creative-attribute-regression": "A/B 테스트 없이 어떤 썸네일이 좋았는지 알 수 있을까?",
  "uplift-holdout-guide": "홀드아웃 테스트로 순수 증가분 읽는 법",
  "store-listing-experiment": "스크린샷을 바꿨을 때 효과를 어떻게 재나?",
  "asa-keyword-expansion": "어떤 검색어를 Exact로 올려야 할까?",
  "ad-machine-learning": "학습 중인 캠페인을 언제까지 두고 봐야 할까?",
...
const EN_H1 = {
  ...
  "performance-marketing-analysis-order": "Which Analysis Can Your Data Actually Support?",
  "incrementality-measurement": "How Much of That Conversion Did Ads Actually Create?",
  "attribution-data-mismatch": "Why Don't GA4 and Your Ad Platform Agree?",
  "store-conversion-drop-diagnosis": "Where to Look When App Store Conversion Falls",
  "apple-search-ads-guide": "How to Find Wasted Keywords in Apple Search Ads",
  "campaign-anomaly-detection": "Is a One-Day CPA Spike Actually an Anomaly?",
  "cpi-cpa-cpm-difference": "What Do CPM, CPC, CPI, and CPA Actually Mean?",
  "creative-attribute-regression": "Can You Tell Which Thumbnail Won Without an A/B Test?",
  "uplift-holdout-guide": "Reading Net Lift From a Holdout Test",
  "store-listing-experiment": "How Do You Measure a Screenshot Change?",
  "asa-keyword-expansion": "Which Search Terms Should You Promote to Exact?",
  "ad-machine-learning": "How Long Should You Leave a Learning Campaign Alone?",
  "aha-event-ad-optimization": "Why Optimizing for Installs Buys You Churn",
};
...
const UPDATED_2026_09_08 = new Set([
  "performance-marketing-analysis-order", "incrementality-measurement", "attribution-data-mismatch", "store-conversion-drop-diagnosis", "apple-search-ads-guide", "campaign-anomaly-detection", "cpi-cpa-cpm-difference", "creative-attribute-regression", "uplift-holdout-guide", "store-listing-experiment", "asa-keyword-expansion", "ad-machine-learning", "aha-event-ad-optimization",
