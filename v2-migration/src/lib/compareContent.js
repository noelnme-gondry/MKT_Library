  ...
  "dashboard-vs-spreadsheet": {
    ...
    ko: {
      ...
      faq: [
        ...
        { q: "CSV를 올리면 데이터가 어디에 저장되나요?", a: "직접 올린 파일과 매핑은 이 브라우저에 마지막 사용 후 90일까지 저장될 수 있습니다. 파싱과 계산은 브라우저 안에서 실행되고 원본 행은 서버로 전송하거나 보관하지 않습니다. 저장 화면에서 언제든 지우거나 저장을 끌 수 있습니다." },
    ...
    en: {
      ...
      faq: [
        ...
        { q: "Where is my CSV stored after upload?", a: "Files you upload directly and their mappings can stay in this browser until 90 days after their last use. Parsing and computation run in your browser, and source rows are never sent to or retained on a server. You can remove them or turn storage off at any time." },
