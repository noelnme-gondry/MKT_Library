export async function register() {
  ...
  if (process.env.NEXT_RUNTIME === "nodejs" && process.env.GOP_SERVICE_WORKER === "true" && process.env.NODE_ENV === "production" && process.env.RAILWAY_ENVIRONMENT_NAME === "production") {
