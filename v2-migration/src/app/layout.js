...
export const metadata = {
  ...
  description: "캠페인 CSV나 구글 시트 연동으로 성과·예산 배분·A/B 테스트를 분석하는 무료 퍼포먼스 마케팅 도구 모음", // 56자
  ...
  openGraph: {
    ...
    description: "캠페인 CSV나 구글 시트로 바로 분석하는 무료 퍼포먼스 마케팅 데이터 도구", // 38자
  ...
  twitter: {
    ...
    title: "Growth Opt Playbook | 마케팅 데이터 분석툴",
    description: "캠페인 CSV나 구글 시트로 바로 분석하는 무료 퍼포먼스 마케팅 데이터 도구",
