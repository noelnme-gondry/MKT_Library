...
export default function DecisionEvidence({ record, locale = "ko", title }) {
  const en = locale === "en";
  ...
  return <section data-information-section="" className="decision-evidence" >
    <header data-information-heading="">{title || (en ? "Evidence at decision time" : "결정 당시 분석 근거")}{evidence.capturedAt && ` · ${evidence.capturedAt.slice(0, 10)}`}</header>
