...
const COPY = {
  ko: {
    ...
    privacySession: "현재 세션에서만 유지됩니다. 새로고침 뒤에도 보려면 유효한 Pro와 기기 저장 설정이 필요합니다.",
    ...
    persistenceHint: "Pro 이용기간 중 저장한 CSV·XLSX 원본 파일과 결정 기록을 이 브라우저에 마지막 사용 후 90일까지 보관하며 서버로 전송하지 않습니다. 공용 기기라면 켜지 마세요. 끄면 저장본은 제거되고 현재 세션 기록은 유지됩니다.",
  ...
  en: {
    ...
    brief: "Export decision notes (.md · free)",
    ...
    privacySession: "Kept for this session only. Active Pro and device storage are required to keep new records after a reload.",
    ...
    persistenceHint: "CSV/XLSX source files and decision records saved while Pro is active stay in this browser until 90 days after their last use and are never sent to a server. Do not enable this on a shared device. Turning it off removes persisted copies while keeping this session's records.",
