...
export default function InfoPopover({ label, children, className = "" }) {
  ...
  return <Popover.Root open={open} onOpenChange={setOpen}>
    <Popover.Trigger className={`info-popover-trigger ${className}`} aria-label={label} onPointerEnter={event => { if (event.pointerType === "mouse") enter(); }} onPointerLeave={leave}><span aria-hidden="true">ⓘ</span></Popover.Trigger>
