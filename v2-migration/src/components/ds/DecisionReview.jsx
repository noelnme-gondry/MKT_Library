...
const COPY = {
  ko: {
    ...
    privacySession: "현재 브라우저 세션에서 도구 간 공유됩니다. 새로고침 뒤에도 보려면 유효한 Pro와 기기 저장 설정이 필요합니다.",
  ...
  en: {
    ...
    privacySession: "Shared across tools for this browser session. Active Pro and device storage are required to keep new records after a reload.",
