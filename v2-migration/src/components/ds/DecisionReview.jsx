...
const COPY = {
  ko: {
    ...
    persistenceHint: "직접 올린 CSV·XLSX 원본 파일과 결정 기록을 이 브라우저에 최대 90일 보관하며 서버로 전송하지 않습니다. 공용 기기라면 켜지 마세요. 끄면 저장본은 제거되고 현재 세션 기록은 유지됩니다.",
  ...
  en: {
    ...
    persistenceHint: "Uploaded CSV/XLSX source files and decision records stay in this browser for up to 90 days and are never sent to a server. Do not enable this on a shared device. Turning it off removes persisted copies while keeping this session's records.",
