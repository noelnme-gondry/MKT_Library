...
export default function Footer() {
  ...
  const copy = isEn
    ...
    : { note: "원본 데이터를 서버에 보내지 않는 무료 퍼포먼스 마케팅 분석 도구.", tools: "분석 도구", learn: "실무 자료", legal: "정책", dashboard: "운영 대시보드", variance: "성과 변동 분석", fatigue: "소재 피로도", budget: "예산 배분", blog: "블로그", glossary: "용어사전", guide: "운영 가이드", templates: "CSV 템플릿", privacy: "개인정보처리방침", terms: "이용약관" };
