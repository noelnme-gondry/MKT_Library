...
export default function SubscriptionCheckout({ locale = "ko" }) {
  ...
  return <div className="subscription-checkout">
    ...
    <div className="checkout-widgets" hidden={!config?.enabled || !checkoutOpen || Boolean(waitingOrder)}><div id="toss-payment-methods" /><div id="toss-payment-agreement" /></div>
    ...
    <details className="checkout-purchase-info"><summary>{en ? "Purchase details" : "구매·이용 안내"}</summary>
