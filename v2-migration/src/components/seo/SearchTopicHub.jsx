...
const TOPICS = {
  ko: [
    ...
    { href: "/tools/paid-organic-trend", kicker: "Paid와 Organic이 반대로 움직일 때", title: "주간 변화맵으로 패턴부터 확인", desc: "최근 주차일수록 진해지는 궤적으로 반대 움직임이 반복되는지 보고, 필요할 때 정밀 잠식 진단으로 이어갑니다.", cta: "변화맵 바로 열기" },
  ...
  en: [
    ...
    { href: "/en/tools/paid-organic-trend", kicker: "When Paid and Organic move apart", title: "Start with the weekly movement map", desc: "Use a darker-is-newer path to spot repeated opposite movement, then continue to detailed diagnosis when needed.", cta: "Open movement map" },
