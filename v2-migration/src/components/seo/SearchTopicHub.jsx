...
const TOPICS = {
  ko: [
    ...
    { href: "/tools/marketing-response?stage=diagnose", kicker: "광고가 오가닉을 잠식할 때", title: "카니발라이제이션 가능성부터 점검", desc: "시계열 점검을 마친 뒤 유료 광고가 원래 들어올 오가닉 성과를 빼앗는지 네 가지 신호로 확인합니다.", cta: "잠식 진단 바로 열기" },
  ...
  en: [
    ...
    { href: "/en/tools/marketing-response?stage=diagnose", kicker: "When ads may displace organic", title: "Start with a cannibalization check", desc: "After the time-series review, use four signals to check whether paid ads may displace organic outcomes.", cta: "Open cannibalization diagnosis" },
