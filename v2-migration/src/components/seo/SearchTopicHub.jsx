...
const TOPICS = {
  ko: [
    ...
    { href: "/tools/marketing-response", kicker: "광고가 오가닉을 잠식할 때", title: "카니발라이제이션부터 확인", desc: "유료 광고가 원래 들어올 오가닉 성과를 빼앗는지 네 가지 신호로 점검합니다.", cta: "카니발라이제이션 진단하기" },
  ...
  en: [
    ...
    { href: "/en/tools/marketing-response", kicker: "When ads may displace organic", title: "Check cannibalization first", desc: "Use four signals to check whether paid ads may be taking outcomes that would have arrived organically.", cta: "Diagnose cannibalization" },
