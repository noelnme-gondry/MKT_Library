...
export const CREATIVE_COPY = {
  performance: {
    ...
    heroJourney: [
      ["1", "어떤 소재가 이기고 있나", "승률·교체 속도·생존 기간"],
      ["2", "어떤 특징이 효과적인가", "후킹 방식·포맷 등 속성별 효과"],
      ["3", "지금 지치는 소재가 있나", "피로도 진단·교체 시점 추천"],
      ["4", "다음엔 뭘 테스트할까", "조합별 성과 기반 후보 추천"],
    ],
    heroCausationBody:
  ...
  content: {
    ...
    heroJourney: [
      ["1", "어떤 콘텐츠가 반응이 좋나", "승률·발행 페이스·생존 기간"],
      ["2", "어떤 특징이 효과적인가", "후킹 유형·형식 등 속성별 효과"],
      ["3", "지금 신선도가 떨어지는 콘텐츠가 있나", "신선도 저하 진단·재발행 시점 추천"],
      ["4", "다음엔 뭘 테스트할까", "조합별 성과 기반 후보 추천"],
    ],
    heroCausationBody:
