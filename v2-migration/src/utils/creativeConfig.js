...
export const CREATIVE_CONFIG = {
  version: "1.1.0", seed: 42, decimalPlaces: 4, minImpressions: 1000, minNCell: 5,
  ...
  fatigueAlert: { minDays: 7, trendWindow: 14, ctrWeight: 0.45, impressionWeight: 0.35, cpmWeight: 0.2, alertScore: 0.5, horizonDays: 30 },
  fatigueRisk: {
    rollingWindow: 3,
    dropPct: 0.2,
    confirmDays: 3,
