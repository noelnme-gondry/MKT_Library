...
| 5-29 | 구성 변화 분석 (분포 TVD·Mix/Rate 무잔차·운영 지문·인과 확인) | 자체 CSV |
...
- ✅ 검증 하네스: `npm run test:all` **325파일·2653 통과**(1 skipped) · eslint 0 errors/0 warnings · `next build` ✓ (2026-08-25 실측). **수치를 적을 땐 실제로 돌려서 적을 것**.
