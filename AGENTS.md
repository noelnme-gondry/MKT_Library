...
- ✅ 검증 하네스: `npm run test:all` **381파일·3010 통과**(0 skipped) · eslint 0 errors/0 warnings · `next build` ✓ — 2026-09-08 실측. `playwright` **25/25**(mobile-320·tablet-768·desktop-1440·light-EN)는 2026-09-01 실측값. **수치를 적을 땐 실제로 돌려서 적을 것**(돌리지 않은 항목은 언제 잰 값인지 함께 남긴다).
