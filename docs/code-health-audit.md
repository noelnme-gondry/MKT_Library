...
§4.2 표가 **6개 도구만 + "17→5/6 통합"**으로 기재 — 실제로 **5-20 핵심 가치 발굴가 활성**(IA `index.html:3468` · `page_5_20` 17889 · `runAhaTests` · `docs/aha-moment-finder-spec.md` 존재). 표에 5-20 추가, "17→7"로 정정 완료.
