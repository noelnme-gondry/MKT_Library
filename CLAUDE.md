...
### 12.35 Q3 WS1~WS3-A 완료 — sticky 필터·capability matrix·PUR 차원 (PR #153~155)
- **WS2(PR#153) MON_FEATURES SSOT**: 8기능 need/boost 정의 → `renderCapabilityMatrix("5-2")`로 gate/upload에 동적 ●/◐ 매트릭스 표시. 비-5-2 도구는 ""반환으로 guard.
